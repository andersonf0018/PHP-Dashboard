...
if (isset($_POST['submit'])) {
    ...
    if ($msg == '') {
        if (isset($_GET['email']) && $_GET['email'] != '') {
            mysqli_query($con, "UPDATE usuarios SET nome='$nome',email='$email',senha='$senha',telefone='$telefone',nivel='0' WHERE email='$id'");
        } else {
            mysqli_query($con, "INSERT INTO usuarios(nome,email,senha,telefone,nivel) VALUES('$nome','$email','$senha','$telefone','0')");
        }
        header('location: pagina_admins.php');
        die();
    }
...
<div class="content pb-0">
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header"><strong>FORMULÁRIO ADMINS</strong></div>
                <form method="post">
